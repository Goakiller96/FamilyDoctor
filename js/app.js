(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new core(".promotion__slider", {
            ...
            navigation: {
                prevEl: ".promotion__buttons .swiper-button-prev",
                nextEl: ".promotion__buttons .swiper-button-next"
            },
            breakpoints: {
                319: {
                    slidesPerView: 1
    ...
    if (document.querySelector(".swiper")) new core(".doctors__slider", {
        modules: [ Navigation, Pagination ],
        observer: true,
        observeParents: true,
        slidesPerView: 1,
        ...
        navigation: {
            prevEl: ".doctors__buttons .swiper-button-prev",
            nextEl: ".doctors__buttons .swiper-button-next"
        },
        breakpoints: {},
        on: {}
    });
    ...
    if (document.querySelector(".swiper")) new core(".clinic__slider", {
        modules: [ Navigation, Pagination ],
        observer: true,
        observeParents: true,
        slidesPerView: 4,
        ...
        navigation: {
            prevEl: ".clinic__buttons .swiper-button-prev",
            nextEl: ".clinic__buttons .swiper-button-next"
        },
        breakpoints: {
            319: {
                slidesPerView: 1,
    ...
    if (document.querySelector(".swiper")) new core(".rewards__slider", {
        modules: [ Navigation, Pagination ],
        observer: true,
        observeParents: true,
        slidesPerView: 4,
        ...
        navigation: {
            prevEl: ".rewards__buttons .swiper-button-prev",
            nextEl: ".rewards__buttons .swiper-button-next"
        },
        breakpoints: {
            319: {
                slidesPerView: 1,
    ...
    if (document.querySelector(".swiper")) new core(".firstqueeze__slider", {
        modules: [ Navigation, Pagination ],
        observer: true,
        observeParents: true,
        slidesPerView: 2,
